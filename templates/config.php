...
$_xhprof['dbuser'] = '{{db_username}}';
$_xhprof['dbpass'] = '{{db_password}}';
$_xhprof['dbname'] = 'xhprof';
$_xhprof['dbadapter'] = 'Pdo';
$_xhprof['servername'] = '{{magento_main_domain}}';
$_xhprof['namespace'] = '{{xhprof_namespace}}';
$_xhprof['url'] = 'http://{{magento_main_domain}}/xhprof_html';
/*
...
$controlIPs[] = "::1";
$controlIPs[] = "{{xhprof_controlip_whitelist}}";        // localhost IP v6
